...
/// <summary>
/// Tests for the result creator.
/// </summary>
[TestFixture]
public class PrintOpenFacilitiesResultCreatorTests
{
    ...
    /// In the output we expect an entry for the opened facility and none for the other facility.
    /// </summary>
    [Test]
    public void TestThatOpenedFacilityWithFittingOpeningCostsIsContainedInResults()
    {
        ...
        cacheLogger.ContainsFittingEntry(s => s.Contains($"Open facility '{cheapestFacility}'")).ShouldBeTrue();
        cacheLogger.ContainsFittingEntry(s => s.Contains($"Open facility '{modelData.Facilities.Last()}'")).ShouldBeFalse();
    }
